...
%             aviobj.CompressionRatio = 2;
    ...
    for i = 1:size(Rd,3)
        ...
        vdz(1) = Rd(2,3,i);
        wdz(1) = Rd(3,3,i);
        quivXhandle = quiver3(odx, ody, odz, udx, vdx, wdx,  'k', 'ShowArrowHead', 'off',  ...
                             'MaxHeadSize', 0.999999, 'AutoScale', 'off','LineWidth',2);
        quivYhandle = quiver3(odx, ody, odz, udy, vdy, wdy,  'k', 'ShowArrowHead', 'off',  ...
                             'MaxHeadSize', 0.999999, 'AutoScale', 'off','LineWidth',2);
        quivZhandle = quiver3(odx, ody, odz, udz, vdz, wdz,  'k', 'ShowArrowHead', 'off',  ...
                             'MaxHeadSize', 0.999999, 'AutoScale', 'off','LineWidth',2);
    end
