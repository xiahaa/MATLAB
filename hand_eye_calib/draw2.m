...
convSols = {'ATA', 'NLOPT', 'SOCP', 'POLY', 'DUAL', 'SCF', 'SE3OPT'};
...
legend('ATA', 'NLOPT', 'SOCP', 'POLY', 'DUAL', 'SCF', 'SE3OPT','Interpreter','latex');
...
fig = figure();
set(fig,'defaulttextinterpreter','latex');
subaxis(4,1,1, 'Margin', subplot_margin, 'Spacing', subplot_spacing);
...
subaxis(4,1,2, 'Margin', subplot_margin, 'Spacing', subplot_spacing);
boxdata = rotErrors{2,10};
boxplot(boxdata,box_labels);
title('Gaussian Noise standard deviation: (0.01)')
ylabel('$E_{R_X}$','Interpreter','latex');

subaxis(4,1,3, 'Margin', subplot_margin, 'Spacing', subplot_spacing);
boxdata = rotErrors{3,10};
boxplot(boxdata,box_labels);
title('Gaussian Noise standard deviation: (0.05)')
ylabel('$E_{R_X}$','Interpreter','latex');

subaxis(4,1,4, 'Margin', subplot_margin, 'Spacing', subplot_spacing);
