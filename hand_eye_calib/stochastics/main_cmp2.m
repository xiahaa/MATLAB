...
A = [];
B = [];
[A, B] = AB_genTraj(X, ElipseParam, [.5, .5, .5, 0, 0], num+shift+1);
...
[MA1,~] = mean_Taylor_1st( A_mex );
[MB1,~] = mean_Taylor_1st( B_mex );
Sigma1 = cov_SE3(MA1, A_mex, 1 );
...
MA2 = mean_Taylor_2nd( A_mex, s_d, n_search );
MB2 = mean_Taylor_2nd( B_mex, s_d, n_search );
...
fprintf('===================================================== \n')
[MA1,~] = mean_Taylor_1st( A_noise_mex );
[MB1,~] = mean_Taylor_1st( B_mex );
Sigma1 = cov_SE3(MA1, A_noise_mex, 1 );
...
MA2 = mean_Taylor_2nd( A_noise_mex, s_d, n_search );
MB2 = mean_Taylor_2nd( B_mex,       s_d, n_search );
